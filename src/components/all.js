...
function All(){
    const[topmovie]=useState(all)
    return(
        <div>
            <h1 style={{color:"red",marginTop:"40px"}}> All Movies</h1>
            <div className="container-fluid">
                <div className="row">
                <div className='col '>
                    {topmovie ? (<ul className='movielistcard row-cols-lg-3 row-cols-md-2 row-cols-sm-1 ms-sm-5 '>{topmovie.map((item)=>(<div key={item.id}>
